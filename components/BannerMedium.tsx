...
const BannerMedium = () => {
  return (
    <section className="w-screen h-[50vh] bg-milkWhite py-[1.5rem]">
      <div className="container mx-auto bg-gray h-full rounded-xl flex relative overflow-hidden">
        <Image
          ...
          height={800}
        />
        <div className="right flex flex-col h-full items-start justify-center gap-[2rem] pl-[5rem] z-20">
