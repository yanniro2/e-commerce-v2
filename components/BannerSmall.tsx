...
const BannerSmall = () => {
  return (
    <section className="w-screen h-[50vh] bg-milkWhite py-[1.5rem]">
      <div className="container mx-auto h-full flex gap-[2rem] items-center justify-between">
        ...
        <div className="right flex flex-col h-full items-start justify-center gap-[2rem] pl-[6rem] bg-gray rounded-xl overflow-hidden">
